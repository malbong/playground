...
toggleBtn.addEventListener('click', function () {
  var top = toggleBtn.offsetTop;
  var right = document.body.offsetWidth - toggleBtn.offsetLeft - toggleBtn.offsetWidth;
  toggleBtn.style.top = "".concat(top, "px");
  toggleBtn.style.right = "".concat(right, "px");
